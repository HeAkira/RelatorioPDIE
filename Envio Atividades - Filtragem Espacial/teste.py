...
def main():
    ...
    masks = {
        ...
        "Mean": np.array([[0.1111, 0.1111, 0.1111], [0.1111, 0.1111, 0.1111], [0.1111, 0.1111, 0.1111]], dtype="float"),
        "Gauss": np.array([[0.0625, 0.125, 0.0625], [0.125, 0.25, 0.125], [0.0625, 0.125, 0.0625]], dtype="float"),
        "Laplacian": np.array([[0, 1, 0], [1, -4, 1], [0, 1, 0]], dtype="int"),
        "Sobel-X": np.array([[-1, 0, 1], [-2, 0, 2], [-1, 0, 1]], dtype="int"),
        "Sobel-Y": np.array([[-1, -2, -1], [0, 0, 0], [1, 2, 1]], dtype="int"),
        "Boost": np.array([[0, -1, 0], [-1, 5.7, -1], [0, -1, 0]], dtype="float")
    }
